...
namespace BMSApplication.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Number,Date,GSTCode,GSTAmount,SupplierId,VendorId,Type")] Invoice invoice)
        {
            ...
            ViewBag.VendorId = new SelectList(db.Vendors, "Id", "Brand", invoice.VendorId);
            return View(invoice);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Number,Date,GSTCode,GSTAmount,SupplierId,VendorId,Type")] Invoice invoice)
        {
            if (ModelState.IsValid)
            {
